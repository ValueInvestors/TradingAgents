...
class MessageBuffer:
    ...
    ANALYST_MAPPING = {
        ...
        "fund_holdings": "Fund Holdings Analyst",
    }
    ...
    REPORT_SECTIONS = {
        ...
        "fund_holdings_report": ("fund_holdings", "Fund Holdings Analyst"),
    ...
    def _update_current_report(self):
        ...
        if latest_section and latest_content:
            ...
            section_titles = {
                ...
                "fund_holdings_report": "ETF Holdings Analysis",
    ...
    def _update_final_report(self):
        ...
        if any(self.report_sections.get(section) for section in analyst_sections):
            ...
            if self.report_sections.get("fund_holdings_report"):
                report_parts.append(
                    f"### ETF Holdings Analysis\n{self.report_sections['fund_holdings_report']}"
                )
...
def display_complete_report(final_state):
    ...
    if final_state.get("fund_holdings_report"):
        analysts.append(("Fund Holdings Analyst", final_state["fund_holdings_report"]))
    if analysts:
...
ANALYST_ORDER = ["market", "social", "news", "fundamentals", "fund_holdings"]
ANALYST_AGENT_NAMES = {
    "market": "Market Analyst",
    "social": "Sentiment Analyst",
    "news": "News Analyst",
...
ANALYST_REPORT_MAP = {
    ...
    "fund_holdings": "fund_holdings_report",
}
