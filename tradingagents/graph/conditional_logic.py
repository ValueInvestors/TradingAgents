...
class ConditionalLogic:
    ...
    def should_continue_fund_holdings(self, state: AgentState):
        """Determine if ETF holdings analysis should continue."""
        messages = state["messages"]
        last_message = messages[-1]
        if last_message.tool_calls:
            return "tools_fund_holdings"
        return "Msg Clear Fund Holdings"
